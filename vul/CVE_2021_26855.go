...
func CheckCVE_2021_26855(target string, result mode.Result) {
	...
	if strings.Contains(string(body), "NegotiateSecurityContext") {
		color.Yellow("[+]%s IsVUL CVE-2021-26855\n", target)
		result.Push(fmt.Sprintf("[+]%s IsVUL CVE-2021-26855\n", target))
	}
}
